    ...
    run: function (creep) {
        ...
        if (!creep.pos.isNearTo(closestSpawn)) {
            if (creep.ticksToLive <= 1400) {
               console.log('<font color = "yellow">[' + fileName + 'line:' + util.LineNumber() + '] 11111111 closestSource.energy is ' + closestSource.energy + '</>');
      ...
      //  creep.debug("yellow",fileName, util.LineNumber(), "creep.name:" +  creep.name);
        ...
        // if miner has energy
        // **********************************************************************************************
        if (creep.store.getFreeCapacity() >=32) {
            var constructionSitesNearMinor = creep.findConstructionSite(1);
            if (creep.room.name == debugRoomName) {
                //  debugColor = "blue";
                  console.log('<font color = '+ debugColor + '>[' + fileName + 'line:' + util.LineNumber() + '] room[' + creep.room.name + '] constructionSitesNearMinor is ' + constructionSitesNearMinor +'</>');       
              }
         ...
         creep.findNearestStructureToRepair(1);
        ...
        if (creep.store.getFreeCapacity() <=4){
          ...
          //   if (creep.room.name == debugRoomName) {
            ...
            // if (Game.time % 2 == 0 ) {
            //     util.buildIt(creep, false);
            // }

            // if (creep.room.name == "E25S52") {
            //     if (Game.time % 5 == 0 ) {
            //         var controller = creep.room.controller;
            //         var upgradControlerStatus= creep.upgradeController(controller)
            //         console.log('<font color = "yellow">[' + fileName + 'line:' + util.LineNumber() + '] upgrading controller Status is ' + upgradControlerStatus +'</>');
            //     }       
            // }
             ...
             // *********************************************************************************
                ...
                //  if (creep.room.name == "E25S52" && transferStatus != 0) {
                //     if (Game.time % 1 == 0 ) {
                //         var controller = creep.room.controller;
                //         var upgradControlerStatus= creep.upgradeController(controller)
                //         console.log('<font color = "yellow">[' + fileName + 'line:' + util.LineNumber() + '] upgrading controller Status is ' + upgradControlerStatus +'</>');
